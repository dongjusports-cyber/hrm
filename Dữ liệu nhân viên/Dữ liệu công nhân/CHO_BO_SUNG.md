...
|--------|---------|----------------------|
| ★★★ | **Sparkline lương thực lãnh 6–7 tháng** (Jan–July 2026) | `sources.salary_by_month` trong JSON / file `Dữ liệu nhân viên/Salary/*.xls` |
...
2. **`Dữ liệu nhân viên/Thông tin danh sách nhân viên/`** — GenusSuite 14.08 + ảnh.
