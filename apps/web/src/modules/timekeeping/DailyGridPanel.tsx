  ...
  const cols = useMemo<ColDef<AttendanceDayGridRow>[]>(
    () => [
      ...
      },
      {
        ...
        width: 88,
        editable: false,
        headerTooltip: "OT ngoài (ATM) — T2/T4/T6/T7, sau 20:00 T3/T5, CN, lễ. Không vào bảng lương chính.",
      ...
      },
      {
        ...
        width: 72,
        editable: false,
        headerTooltip: "OT Chủ nhật — thuộc OT ngoài (ATM), hệ số 2. Không cộng cột Công.",
      ...
      },
      {
        ...
        width: 64,
        editable: false,
        headerTooltip: "OT ngày lễ — thuộc OT ngoài (ATM), hệ số 2/3. Không cộng cột Công.",
