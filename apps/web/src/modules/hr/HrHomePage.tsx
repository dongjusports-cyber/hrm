...
const TILES: HubTile[] = [
  ...
  },
  {
    ...
    description: "Mở hồ sơ và nhập thông tin NV mới",
    to: "/m/hr/employees/new",
    countKey: "none",
  },
  {
    key: "raise",
    ...
    <div className="hr-hub">
      <div className="hr-hub-head">
        ...
        <p className="field-hint">
          Chọn nhóm hoặc chức năng — mở toàn màn hình. Hồ sơ giấy nằm trong tab hồ sơ từng NV.
        </p>
      </div>
        ...
        {TILES.map((tile) => {
          ...
          return (
            <button
              ...
              onClick={() => navigateSmooth(navigate, tile.to)}
            >
